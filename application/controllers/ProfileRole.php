...
class ProfileRole extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('login1/profileadmin/view_profilerole',$data);
	...
	public function get_emp_list($dir_id)
	{
		...
		public function grant_profile_role($id)
 		{
		$this->Profilemodel->grant_profile_role($id);
		$this->Profilemodel->closeConn();
		$response = 'OK';
		echo $response;
		 }

		public function revoke_profile_role($id)
 		{
		$this->Profilemodel->revoke_profile_role($id);
		$this->Profilemodel->closeConn();
		$response = 'OK';
		echo $response;
		 }
