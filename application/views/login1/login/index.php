					...
					<fieldset>
						<div class="form-group" >
							<span class="input-icon">
								<?php  echo form_input(array('name'=>'username','placeholder'=>'IPAS No','class'=>'form-control' ));?>	
					  ...
					  <div class="form-actions">
							...
							<label for="remember" class="pull-right">
								<a href="<?php echo base_url('registration') ?>" data-target="#signup-box" class="user-signup-link">Register
