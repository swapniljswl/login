 ...
 <div  class="row form-group" >
   <div class="col-md-12" align="text-center">
      ...
      <div class="row form-group">
          ...
          <div class="col-md-12">
        <!--   <span class="label label-default col-md-2 text-primary">Directorate:</span>-->
        ...
        <!--    <input type="text" id="request_date" name="request_date">
            <input  type="hidden" id="alternate_date" name="alternate_date"> -->
     <?php 
    ...
    <b> To:-</b>
        ...
        <!--    <input type="text" id="request_date2" name="request_date2">
            <input  type="hidden" id="alternate_date2" name="alternate_date2">-->
         <?php 
...
//	alert(dt1);alert(dt2);exit;
    ...
    $('#fset_emp_list').addClass('show');
      ...
      html+="<td>"+data[index].verified_by+"</td>"; 
       html+="<td>"+data[index].verified_on+"</td>"; 
