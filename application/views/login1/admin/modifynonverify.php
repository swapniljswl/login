...
<h4 class="text-center" style="color: blue";>Modify Non Verify/Rejected Users/गैर-सत्यापित/अस्वीकृत उपयोगकर्ताओं को संशोधित करें</h4>
   <?php   $message = $this->session->flashdata('role');
               ...
               ?> 
				 <?php echo form_open('Userverifyreject/selectemp'); ?>  <div class="row">        		
