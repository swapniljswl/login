...
class Modifynonverify extends CI_Model
{
 ...
 public function getuser($typeuser)
 {
	...
	a.desig_id = d.desig_id and a.dte_id='$direc' and (b.status ='' or b.status is NULL or b.status='r') order by a.name asc";
	} elseif ($typeuser=='2')
	{
	...
	where a.aadhar_no=b.aadhar_no and a.nodal_dte=c.dte_id and 
	 a.nodal_dte='$direc' and (b.status ='' or b.status is NULL or b.status='r') order by a.name asc"; 	
